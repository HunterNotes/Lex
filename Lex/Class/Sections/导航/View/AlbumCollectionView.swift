...
private let albumCellID = "AlbumCollectionViewCell"

class AlbumCollectionView: UICollectionView {
    
    var showPicBlock : SeletedPicBlock?
...
extension AlbumCollectionView: UICollectionViewDataSource, UICollectionViewDelegate,UICollectionViewDelegateFlowLayout {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: albumCellID, for: indexPath) as! AlbumCollectionViewCell
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if (self.showPicBlock) != nil {
            self.showPicBlock!(self.imgArr[item])
        }
    }
}
