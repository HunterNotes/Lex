...
class DCAlbumViewController: UIViewController {
...
extension DCAlbumViewController {
    ...
    fileprivate func setupUI() {
        ...
        btn.frame = CGRect(x: 100, y:app_height - 100 , width: 100, height: 100)
...
extension DCAlbumViewController : UITableViewDelegate, UITableViewDataSource {
