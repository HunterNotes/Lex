...
class ScanCodeTool: NSObject {
    ...
    //MARK: - 单例
    class func shareTool() -> ScanCodeTool {
        
        struct single {
            static var tool : ScanCodeTool? = ScanCodeTool()
        }
        return single.tool!
    }
...
extension ScanCodeTool : UIImagePickerControllerDelegate, UINavigationControllerDelegate {
